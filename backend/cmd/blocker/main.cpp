...
static void launch_target(const std::wstring& cmd_line) {
    ...
    CreateProcessW(nullptr, cl.data(), nullptr, nullptr,
                   ...
                   LPSTR /*lpCmdLine*/, int /*nCmdShow*/)
{
    ...
    try {
        ...
        auto [resp_bytes, ec] = client.call("locktime.LockTimeService", "CheckApp", req_bytes);
    ...
    MessageBoxW(nullptr, msg.c_str(), L"AppLocker", MB_OK | MB_ICONINFORMATION | MB_TOPMOST);
    return 0;
}
