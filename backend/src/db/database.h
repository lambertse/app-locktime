...
public:
    ...
    void                     patch_rule(const std::string& id,
    ...
    int                      get_daily_minutes(const std::string& rule_id,
    ...
    std::vector<AuditEntry>  get_audit_attempts(const std::string& from, const std::string& to,
...
private:
    ...
    std::vector<Schedule> load_schedules_for_rule_locked(const std::string& rule_id);
