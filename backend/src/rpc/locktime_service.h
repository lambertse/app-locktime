...
// Forward-declare generated proto type to avoid including locktime.pb.h in this header.
namespace locktime { namespace rpc { class Rule; } }
...
private:
    ...
    static void fill_proto_rule(const locktime::Rule& r, ::locktime::rpc::Rule* proto);

#ifdef _WIN32
    static void set_ifeo  (const std::string& exe_name, const std::string& blocker_path);
